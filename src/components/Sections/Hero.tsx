...
export const Hero = ({ t, handleNavClick }: HeroProps) => {
  ...
  return (
    ...
    <div className="container hero-container" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', position: 'relative', zIndex: 1 }}>
      ...
      <h1 className="hero-h1 animate-fade-in-up" style={{ color: 'var(--text-main)', fontWeight: '600', maxWidth: '800px', margin: '0 0 16px 0', lineHeight: '1.5', animationDelay: '0.2s' }}>
        {t.hero.title}
      </h1>
      ...
      <div className="hero-buttons animate-fade-in-up" style={{ marginBottom: '32px', animationDelay: '0.5s' }}>
      ...
      <div className="google-badge-wrapper animate-fade-in-up" style={{ marginTop: '0', animationDelay: '0.6s' }}>
